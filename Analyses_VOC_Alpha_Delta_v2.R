...
# ggsave("Alpha_Delta_V4.png", width=10.5, height=8, dpi=1000)
...
# ggsave("Diff_Alpha_Delta_V4.png", width=9, height=7, dpi=1000)
...
# ggsave("Diff_Alpha.png", width=5, height=4, dpi=1000)
...
# ggsave("Diff_Delta.png", width=5, height=4, dpi=1000)
...
# ggsave("approx_early_rate_Q.png", width=10, heigh=6, dpi=600)
...
# ggsave("approx_early_rate_Q_poster.png", width=6, heigh=5, dpi=1000)
